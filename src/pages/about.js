        ...
        <Section>
          <Infos>
            ...
            <p>
              ...
              love and passion in it, and the fact that a few people uses it
              makes me happy.
            </p>
            ...
            <p>
              ...
              manually, which can explain some delay sometimes between Madam
              Nazar location and what the API returns.
            </p>
          ...
          <Infos>
            ...
            <p>
              ...
              for his amazing work on the collector's map &amp; for allowing us
              to use it on {WEBSITE_NAME}
            </p>
            <p>
              Also, thanks to{" "}
              <a
              ...
              for his top notch work on the css effect to: "Recreate the Red
              Dead Redemption 2 Tintype Loading Screen Effect in CSS".
            </p>
          ...
          >
            ...
            <div className="md:d-grid g-4 w-100p">
              <a href="https://www.gtabase.com/news/red-dead-redemption-2/red-dead-online-how-to-easily-reach-rank-20-in-each-role-thanks-to-the-community">
                <Image filename="gtabase_com_logo_red.png" />
              </a>
            </div>
          </Infos>
        </Section>
