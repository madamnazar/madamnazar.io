...
const SimpleMapNavigation = ({ parent }) => {
  return (
    ...
    >
      ...
      <li className="fx-1 mb-8 tt-upper">
        <button
          onClick={() =>
            parent.setState({
...
class SimpleMap extends React.Component {
  ...
  render() {
    ...
    const hideoutMarker = leaflet.icon({
      iconUrl: "/images/gang-icon.png",
      ...markerOptions,
      iconSize: [25, 25],
      shadowUrl: "/images/danger-shadow.png",
    })
  ...
  render() {
    return (
      <>
        ...
        <div
          className="pos-relative ph-16 m-auto"
          css={css`
            max-width: 960px;
          `}
        >
          ...
          <ul className="lis-none p-0 d-flex m-0 pv-8">
            {[
              {
                id: "simple",
                name: "Default",
              ...
              { id: "random", name: "Random items", status: 1 },
            ].map(map => (
              <li
